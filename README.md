...
```JSX
  <SVG icon="code" hideMobile width={48} fill={colors.orange} left="10%" top="20%" />
  <SVG icon="emacs" width={48} fill={colors.red} left="60%" top="70%" />
  <SVG icon="r2d2" width={6} fill={colors['grey-darker']} left="60%" top="15%" />
```

- For `icon`, you have the options: `code, rome, js, chess, r2d2, emacs`
